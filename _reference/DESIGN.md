...
| `preview/*.html` | The 14 design-system cards |
| `VinylSeeker Wireframes.html` | Original wireframes |
| `Homepage Hi-Fi.html` | Hi-fidelity homepage reference |
...
- **Logo** is the first pass — vinyl-mark + Frank Ruhl Libre wordmark.
- **No full UI kit yet** — only foundations + atomic components.
